...
export const treeRowVariants = cva("flex items-center gap-2 rounded-md px-2 py-1.5 text-sm transition-colors cursor-pointer select-none group/row relative", {
    variants: {
        selected: {
